package com.youedata.generator.generator.common.mybatisplus;
 ...
 */
public class MpGenerator extends AbstractMpGenerator {

    private MpParam mpContextParam;

    public MpGenerator(MpParam mpContextParam) {
...
//        strategyConfig.setTableFillList(tableFills);
        ...
        String SpecParamsTemplatePath = "/mpTemplates/specDTO.java.vm";
