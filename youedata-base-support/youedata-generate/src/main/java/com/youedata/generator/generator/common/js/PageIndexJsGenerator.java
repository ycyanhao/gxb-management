 ...
 */
public class PageIndexJsGenerator extends AbstractCustomGenerator {

    public PageIndexJsGenerator(Map<String, Object> tableContext) {
        super(tableContext);
    }
    ...
    public String getTemplateResourcePath() {
        return "/commonTemplates/page.js.btl";
    }
