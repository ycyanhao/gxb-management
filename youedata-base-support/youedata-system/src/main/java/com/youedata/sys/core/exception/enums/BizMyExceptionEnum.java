 ...
 */
package com.youedata.sys.core.exception.enums;
 ...
 */
public enum BizMyExceptionEnum implements ServiceExceptionEnum {


    /**
     * 分组
     */
    REQUEST_EMPTY(400, "请求数据不完整或格式错误"),
    GROUP_IS_NOT_EXIST(90001, "分组不存在"),
    GROUP_IS_EXIST(90002, "分组存在"),
     ...
     * token异常
     */
    TOKEN_EXPIRED(700, "userToken过期"),
    TOKEN_ERROR(700, "userToken验证失败"),
    TOKEN_EXPIRED_NOT_EXIST(703, "userToken不存在"),
    ...
    BizMyExceptionEnum(int code, String message) {
        this.code = code;
