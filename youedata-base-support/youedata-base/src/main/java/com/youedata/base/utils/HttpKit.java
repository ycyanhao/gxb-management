package com.youedata.base.utils;
...
public class HttpKit {
    ...
    public static Map<String, String> getRequestParameters() {
        ...
        //path参数
        Map<String, Object> valuesForPath = (Map<String, Object>) request.getAttribute(View.PATH_VARIABLES);
        if (null != valuesForPath) {
            for (Entry<String, Object> entry : valuesForPath.entrySet()) {
