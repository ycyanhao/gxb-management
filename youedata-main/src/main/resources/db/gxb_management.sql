DROP DATABASE IF EXISTS gxb_management;
CREATE DATABASE IF NOT EXISTS gxb_management DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `database_info` VALUES (1240625039548657665, 'master', 'com.mysql.cj.jdbc.Driver', 'root', 'root', 'jdbc:mysql://192.168.11.128:3306/zktr_management?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2020-03-19 21:03:53');
